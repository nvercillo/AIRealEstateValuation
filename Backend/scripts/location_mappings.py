...
# all_props = prop_model._query_all()
# print(all_props)
# exit()

all_props = [prop_model._query_by_id(
"98cb98f9-c7d2-43ad-a3d4-60804a2a2b46")]
...
for p in all_props:
    ...
    for n in nearby: 
        ...
        dist_to_node = Math().calc_dist_bw_coords( (p.latitude, p.longitude), (n.latitude, n.longitude))
